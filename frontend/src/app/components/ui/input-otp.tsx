...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-10 w-10 items-center justify-center border border-input bg-background text-sm font-medium shadow-xs transition-all outline-none rounded-md",
