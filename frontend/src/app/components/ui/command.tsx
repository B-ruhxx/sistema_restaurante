    ...
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden p-0 shadow-2xl">
        <Command className={cn(
          ...
          "[&_[cmdk-input-wrapper]]:h-12 [&_[cmdk-input-wrapper]_svg]:size-5",
          "[&_[cmdk-input]]:h-12",
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "placeholder:text-muted-foreground flex h-full w-full rounded-md bg-transparent py-3 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        {...props}
      />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground ml-auto text-xs tracking-widest font-mono opacity-60",
        className,
      )}
      {...props}
    />
